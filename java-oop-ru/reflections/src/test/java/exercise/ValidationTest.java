...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        ...
        List<String> errMsg1 = Arrays.asList("length is less than 4");
        List<String> errMsg2 = Arrays.asList("can't be null");
        expected1.put("country", errMsg1);
        expected1.put("street", errMsg2);
